          ...
          <div class="col-12">
            <div class="login-card"><img class="img-fluid bg-img-cover" src="../assets/images/a-pos/punto.jpeg" alt="">
              <form class="theme-form login-form" method="POST" action="{{ route('login') }}">
                  ...
                  <h4>Login</h4>
                  <h6>¡Bienvenido! Inicie sesión en su cuenta.</h6>
                </div>
                <div class="form-group">

                </div>
                <div class="login-social-title">
                  <h5>Iniciar sesión con correo electrónico</h5>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  </div><a class="link" href="forget-password.html">¿Olvidó su contraseña?</a>
                </div>
                <div class="form-group">
                  <button class="btn btn-primary btn-block" type="submit">Iniciar</button>
                </div>
                <p>¿No tienes cuenta?<a class="ms-2" href="/">Crear Cuenta </a></p>
              </form>
            </div>
          </div>
        </div>
