                  ...
                  <div class="card-body">
                    <div class="dt-ext table-responsive">
                      <table class="display" id="export-button">
                        ...
                        <tbody>
                        @foreach ($reporte_ventas as $reporte_venta)
                          <tr>
                            <td>{{ $reporte_venta->codigo }}</td>
                            <td>{{ $reporte_venta->categoria }}</td>
                            <td>{{ $reporte_venta->producto }}</td>
                            <td>{{ $reporte_venta->cantidad }}</td>
                            <td>{{ $reporte_venta->fecha_venta }}</td>
                            <td>{{ $reporte_venta->total_venta }}</td>
                          </tr>
                        @endforeach
                        </tbody>
                        <tfoot>
